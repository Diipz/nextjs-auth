    ...
    return (
        <section id="contact-section" className="bg-black text-white py-[72px] sm:py-24 text-center">
            <div className="container max-w-xl relative">
                <h2 className="font-bold text-5xl tracking-tighter md:text-6xl">Get in touch</h2>
                <p className="text-large text-white/70 mt-5">Contact us for personalised help, support or enquiries to address your needs</p>
