    ...
    return (
        <section id="contact-section" className="bg-black text-white py-[72px] sm:py-24 text-center">
            <div className="container max-w-xl relative">
                ...
                <form className="mt-10 flex flex-col gap-2.5 max-w-sm mx-auto sm:flex-row" autoComplete="off">
                    <input id="email" type="email" placeholder="your@email.com" autoComplete="off" className="h-12 bg-white/20 rounded-lg px-5 font-medium placeholder:text-[#9CA3AF] flex-1" />
